...
function renderTreeToList2(treeArray) {
...
export function renderPage() {
  ...
  const flatTree = flattenTree(browserTree);
  rootDiv.append(renderArray(flatTree));
  const list2 = renderTreeToList2(flatTree);
  if (list2 !== null) rootDiv.append(list2);
}
